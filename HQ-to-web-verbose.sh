...
find "$PICTURES" -name '*.jpg' -exec sh -c 'convert -verbose -resize 25% "$0" "${0%%.jpg}.jpg"' {} \;
...
find "$PICTURES" -name '*.jpeg' -exec sh -c 'convert -verbose -resize 25% "$0" "${0%%.jpeg}.jpeg"' {} \;
...
find "$PICTURES" -name '*.jpg' -exec sh -c 'cwebp -v -mt -q 75 -m 6 "$0" -o "${0%%.jpg}.webp"' {} \;

#Same as above but with the .jpeg file extension instead of the .jpg file extension. This does nothing if they are all in the .jpg file extension.

find "$PICTURES" -name '*.jpeg' -exec sh -c 'cwebp -v -mt -q 75 -m 6 "$0" -o "${0%%.jpeg}.webp"' {} \;

#Takes all JPEG pictures in the directory and encodes them at 80% quality.

find "$PICTURES" -name '*.jpg' -exec sh -c 'convert -verbose -quality 80 "$0" "${0%%.jpg}.jpg"' {} \;

#Same as above but with the .jpeg file extension instead of the .jpg file extension. This does nothing if they are all in the .jpg file extension.

find "$PICTURES" -name '*.jpeg' -exec sh -c 'convert -verbose -quality 80 "$0" "${0%%.jpeg}.jpeg"' {} \;
...
find "$PICTURES" -name '*.jpg' -exec sh -c 'jpegoptim -v --strip-all --all-progressive "$0" "${0%%.jpg}.jpg"' {} \;

#Same as above but with the .jpeg file extension instead of the .jpg file extension. This does nothing if they are all in the .jpg file extension.

find "$PICTURES" -name '*.jpeg' -exec sh -c 'jpegoptim -v --strip-all --all-progressive "$0" "${0%%.jpeg}.jpeg"' {} \;
